    ...
    >
        ...
        >
            <tbody>
                {/* Header */}
                <tr>
                    <td style={{ padding: "32px 28px 24px 28px", borderBottom: "1px solid #e2e8f0", textAlign: "center" }}>
                        ...
                        <h1 style={{ margin: "10px 0 0 0", fontSize: "24px", fontWeight: 700, color: "#0f172a" }}>
                ...
                <tr>
                    <td style={{ padding: "32px 28px" }}>
                        <p style={{ fontSize: "16px", fontWeight: 600, color: "#0f172a", marginTop: 0 }}>Hi {name},</p>
