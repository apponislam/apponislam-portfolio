...
export const AutoReplyEmailTemplate: React.FC<AutoReplyEmailTemplateProps> = ({ name }) => (
    <div
        style={{
        ...
        >
            ...
            >
                <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                    ...
                    />
                    <span style={{ fontSize: "12px", fontWeight: 600, color: "#10b981", textTransform: "uppercase", letterSpacing: "1px" }}>Message Received</span>
                </div>
                <h1 style={{ margin: "8px 0 0 0", fontSize: "24px", fontWeight: 700, color: "#ffffff" }}>Thanks for reaching out!</h1>
            </div>

            {/* Content Body */}
            <div style={{ padding: "32px 28px" }}>
                <p style={{ fontSize: "16px", fontWeight: 600, color: "#ffffff", marginTop: 0 }}>Hi {name},</p>
                <p style={{ fontSize: "15px", lineHeight: "1.6", color: "#a1a1aa" }}>Thank you for connecting with me through my portfolio. I’ve received your message and will review it promptly.</p>
                <p style={{ fontSize: "15px", lineHeight: "1.6", color: "#a1a1aa" }}>I usually respond within 24 hours.</p>
                ...
                <div style={{ marginTop: "32px", paddingTop: "20px", borderTop: "1px solid #27272a", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                        <p style={{ margin: 0, fontSize: "14px", fontWeight: 600, color: "#ffffff" }}>Appon Islam</p>
                        <p style={{ margin: "4px 0 0 0", fontSize: "13px", color: "#71717a" }}>Full Stack Developer & Software Engineer</p>
                    </div>
            ...
            >
                <p style={{ margin: 0 }}>
                    © {new Date().getFullYear()} Appon Islam •{" "}
