                    ...
                    <CustomTooltip key={link.label} text={link.tooltip}>
                        <Link
                            ...
                            className={cn(
                                ...
                                "flex items-center gap-1.5 border border-muted bg-background/50 text-foreground/80 hover:text-foreground hover:bg-accent/50 transition-all duration-200 shadow-xs rounded-full px-3.5 py-1.5 text-xs font-semibold cursor-pointer w-full justify-start whitespace-nowrap",
                                link.colorClass,
                            )}
                        >
