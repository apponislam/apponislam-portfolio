...
export function ResumeSection() {
    ...
    return (
        <section id="resume" className="md:container space-y-8 py-10 my-14 dark:bg-transparent overflow-x-hidden">
            {/* Section Header */}
            ...
            <div className="mx-auto grid gap-10 lg:grid-cols-2 lg:w-full 2xl:w-300 pt-8">
                <ExperienceSection />
                <EducationSection />
            </div>
        </section>
