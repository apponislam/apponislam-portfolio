        ...
        <div className="relative min-h-[85vh] flex flex-col items-center justify-center text-center px-4 py-12">
            ...
            <div className="max-w-md w-full space-y-6">
                ...
                <div className="relative inline-flex items-center justify-center">
                    <span className="font-heading text-8xl sm:text-9xl font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-b from-foreground via-foreground/80 to-muted-foreground/30 select-none">
                        404
                    </span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 w-full">
                    <Link
                        ...
                        className={cn(
                            ...
                            "w-full sm:w-auto px-6 font-semibold shadow-md transition-all hover:scale-[1.02]"
                        )}
                    >
                    ...
                    <Link
                        ...
                        className={cn(
                            ...
                            "w-full sm:w-auto px-6 font-semibold transition-all"
                        )}
                    >
