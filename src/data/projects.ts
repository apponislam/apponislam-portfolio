        ...
        contributions: [
            {
                ...
                highlights: [
                    "Developed full-stack bike e-commerce platform with Next.js, Express.js, and MongoDB.",
                    "Integrated JWT role authentication, product filter workflows, and SurjoPay checkout.",
                ],
            },
        ],
        ...
        contributions: [
            {
                ...
                linkedinUsername: "apponislam",
                highlights: [
                    "Built MERN learning management system with role-based dashboards for students, teachers, and admins.",
                    "Implemented class approval workflows, TanStack Query caching, and SurjoPay course enrollment.",
                ],
            },
        ],
        ...
        contributions: [
            {
                ...
                linkedinUsername: "apponislam",
                highlights: [
                    "Engineered collaborative study platform allowing users to create, attempt, and grade assignments.",
                    "Implemented PDF preview integration, JWT auth, theme toggle, and react-hook-form validation.",
                ],
            },
        ],
        ...
        contributions: [
            {
                ...
                linkedinUsername: "apponislam",
                highlights: [
                    "Developed craft e-commerce application with category/sub-category browsing & management.",
                    "Integrated Firebase auth, JWT protected routes, dark/light theme, and CRUD dashboards.",
                ],
            },
        ],
        techStack: ["React", "Tailwind CSS", "Node.js", "Express.js", "MongoDB", "Firebase", "Typescript", "Javascript", "HTML 5", "CSS 3", "Google Auth"],
        ...
        contributions: [
            {
                ...
                linkedinUsername: "apponislam",
                highlights: [
                    "Created full-stack idea sharing platform with PostgreSQL, Prisma ORM, and Next.js.",
                    "Implemented SSLCommerz paid content access, Reddit-style nested comments, and voting.",
                ],
            },
        ],
        ...
        contributions: [
            {
                ...
                linkedinUsername: "apponislam",
                highlights: [
                    "Architected full-stack household budget tracker across Next.js web app and React Native mobile app.",
                    "Engineered real-time shared mess accounting, market price trend analytics, and PDF invoice generation.",
                ],
            },
        ],
        ...
        contributions: [
            {
                ...
                linkedinUsername: "apponislam",
                highlights: [
                    "Built travel & property listing platform using Next.js 15, Express 5, and Socket.io.",
                    "Integrated Stripe membership subscriptions, host verification workflows, and real-time chat.",
                ],
            },
        ],
        ...
        contributions: [
            {
                ...
                linkedinUsername: "apponislam",
                highlights: [
                    "Architected full-stack e-commerce app using Next.js 16, TypeScript, Express.js, PostgreSQL, and Prisma ORM.",
                    "Integrated Stripe payments, ShipStation automated logistics, multi-tier memberships, and Resend notifications.",
                ],
            },
        ],
