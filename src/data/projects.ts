...
export const projects: Project[] = [
        ...
        contributions: [
            {
                ...
                highlights: ["Developed full-stack bike e-commerce platform with Next.js, Express.js, and MongoDB.", "Integrated JWT role authentication, product filter workflows, and SurjoPay checkout."],
            },
        ],
        ...
        contributions: [
            {
                ...
                profileImage: "/appon.webp",
                linkedinUsername: "apponislam",
                highlights: ["Built MERN learning management system with role-based dashboards for students, teachers, and admins.", "Implemented class approval workflows, TanStack Query caching, and SurjoPay course enrollment."],
            },
        ],
        ...
        contributions: [
            {
                ...
                profileImage: "/appon.webp",
                linkedinUsername: "apponislam",
                highlights: ["Engineered collaborative study platform allowing users to create, attempt, and grade assignments.", "Implemented PDF preview integration, JWT auth, theme toggle, and react-hook-form validation."],
            },
        ],
        ...
        contributions: [
            {
                ...
                profileImage: "/appon.webp",
                linkedinUsername: "apponislam",
                highlights: ["Developed craft e-commerce application with category/sub-category browsing & management.", "Integrated Firebase auth, JWT protected routes, dark/light theme, and CRUD dashboards."],
            },
        ],
        techStack: ["React", "Tailwind CSS", "Node.js", "Express.js", "MongoDB", "Firebase", "Typescript", "Javascript", "HTML 5", "CSS 3", "Google Auth"],
        ...
        contributions: [
            {
                ...
                profileImage: "/appon.webp",
                linkedinUsername: "apponislam",
                highlights: ["Created full-stack idea sharing platform with PostgreSQL, Prisma ORM, and Next.js.", "Implemented SSLCommerz paid content access, Reddit-style nested comments, and voting."],
            },
        ],
    ...
    },
    {
        ...
        contributions: [
            {
                ...
                profileImage: "/appon.webp",
                linkedinUsername: "apponislam",
                highlights: ["Architected full-stack household budget tracker across Next.js web app and React Native mobile app.", "Engineered real-time shared mess accounting, market price trend analytics, and PDF invoice generation."],
            },
        ],
        ...
        images: [
            ...
            "/projects/mybazarhisab/mybazarhisab2.webp",
            "/projects/mybazarhisab/mybazarhisab3.webp",
            "/projects/mybazarhisab/mybazarhisab4.webp",
            "/projects/mybazarhisab/mybazarhisab5.webp",
            "/projects/mybazarhisab/mybazarhisab6.webp",
            "/projects/mybazarhisab/mybazarhisab7.webp",
            "/projects/mybazarhisab/mybazarhisab8.webp",
            "/projects/mybazarhisab/mybazarhisab9.webp",
            "/projects/mybazarhisab/mybazarhisab10.webp",
            "/projects/mybazarhisab/mybazarhisab11.webp",
            "/projects/mybazarhisab/mybazarhisab12.webp",
            "/projects/mybazarhisab/mybazarhisab13.webp",
        ],
        descriptionDetails: {
            paragraphs: [
    ...
    },
    {
        ...
        contributions: [
            {
                name: "Shahriar Alom Bhuiyan",
                role: "UI/UX Designer",
                profileImage: "/team/sahriarvai.webp",
                linkedinUsername: "shahriar-alom-bhuiyan-036079225",
                highlights: ["Designed intuitive user interfaces and seamless UX workflows for short-term stays and festival property listings.", "Created responsive wireframes, design system components, and interactive prototypes."],
            },
            {
                name: "Appon Islam",
                role: "Full Stack Developer",
                profileImage: "/appon.webp",
                linkedinUsername: "apponislam",
                highlights: ["Built travel & property listing platform using Next.js 15, Express 5, and Socket.io.", "Integrated Stripe membership subscriptions, host verification workflows, and real-time chat."],
            },
        ],
        ...
        descriptionDetails: {
            paragraphs: [
                ...
                "The architecture consists of a modern Next.js 15 frontend optimized for SEO and performance, and a robust Node.js backend. The platform supports complex features such as tiered subscription plans, Stripe-powered payments and webhook handling, real-time messaging with host/guest chat, and automated bot messages.",
            ],
            bullets: [
                "Built a high-performance, responsive frontend with Next.js 15, React 19, and Tailwind CSS v4.",
                "Engineered a scalable backend API using Node.js, Express 5, and TypeScript.",
                "Implemented an advanced property management system with location, listing, and active listing workflows.",
                "Integrated Stripe for handling transactions, subscriptions (plans & memberships), and webhook events.",
                "Developed a robust Host Verification system to ensure platform trust and safety.",
                "Set up real-time bidirectional messaging between users using Socket.io.",
                "Designed a comprehensive admin dashboard to manage users, reports, reviews, and dynamic content.",
        ...
        contributions: [
            {
                ...
                profileImage: "/appon.webp",
                linkedinUsername: "apponislam",
                highlights: ["Architected full-stack e-commerce app using Next.js 16, TypeScript, Express.js, PostgreSQL, and Prisma ORM.", "Integrated Stripe payments, ShipStation automated logistics, multi-tier memberships, and Resend notifications."],
            },
        ],
    ...
    },
    {
        ...
        contributions: [
            {
                ...
                role: "UI/UX Designer",
                profileImage: "/team/labibvai.webp",
                linkedinUsername: "ahmad-zakaria-labib-b798a31ab",
                highlights: ["Designed intuitive UI/UX for P2P marketplace mobile app and offer negotiation screens.", "Created design system, user wireframes, and interactive prototypes for seller onboarding."],
            },
            {
                name: "Rimon Islam",
                role: "Flutter Developer",
                profileImage: "/team/rimon.webp",
                linkedinUsername: "rimon-islam-797004239",
                highlights: ["Developed cross-platform Flutter application for iOS & Android with custom UI components.", "Integrated Paydunya/Wave mobile payments, push notifications, and DExchange SMS verification."],
            },
            {
                name: "Appon Islam",
                role: "Full Stack Developer",
                profileImage: "/appon.webp",
                linkedinUsername: "apponislam",
                highlights: ["Architected scalable Express.js backend with Socket.IO real-time offer negotiation & chat.", "Built Next.js admin dashboard and managed Play Store & App Store deployment pipelines."],
            },
        ],
        ...
        endDate: "2026-08-30",
        companyLogoImg: "/projects/djarna/djarna1.webp",
        images: [
            "/projects/djarna/djarna1.webp",
            "/projects/djarna/djarna2.webp",
            "/projects/djarna/djarna3.webp",
            "/projects/djarna/djarna4.webp",
            "/projects/djarna/djarna5.webp",
            "/projects/djarna/djarna6.webp",
            "/projects/djarna/djarna7.webp",
            "/projects/djarna/djarna8.webp",
            "/projects/djarna/djarna9.webp",
            "/projects/djarna/djarna10.webp",
            "/projects/djarna/djarna11.webp",
            "/projects/djarna/djarna12.webp",
            "/projects/djarna/djarna13.webp",
            "/projects/djarna/djarna14.webp",
            "/projects/djarna/djarna15.webp",
            "/projects/djarna/djarna16.webp",
            "/projects/djarna/djarna17.webp",
        ],
        descriptionDetails: {
            paragraphs: [
